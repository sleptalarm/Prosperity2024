    ...
    def run(self, state: TradingState) -> tuple[dict[Symbol, list[Order]], int, str]:
        ...
        for product, order_depth in state.order_depths.items():
            if product == 'AMETHYSTS':
                ...
                acceptable_price_buy = 10001
                acceptable_price_sell = 10000
                best_price_buy = 9995
                best_price_sell = 10005
                ...
                if len(order_depth.sell_orders) != 0:
                    ...
                    for i in range(len(tmp_list)):
                        ...
                        if int(price) <= acceptable_price_buy:
                            ...
                            # amount_new = round(amount * np.power(self.discount,price - best_price_buy))
                ...
                if len(order_depth.buy_orders) != 0:
                    ...
                    for i in range(len(tmp_list)):
                        ...
                        if int(price) >= acceptable_price_sell:
                            ...
                            # orders[product].append(Order(product, price, amount))
                            # amount_new = round(amount * np.power(self.discount,best_price_sell - price))
                            orders[product].append(Order(product, price, max(-amount, -limit)))
                        else:
                            break
